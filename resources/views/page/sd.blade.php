...
<body>
    ...
    <div class="container bs-docs-container br">
        ...
        <ul class="nav nav-tabs br" role="tablist">
            <li role="presentation" class="active"><a href="#sd" aria-controls="sd" role="tab" data-toggle="tab"><h3>SD</h3></a></li>
            <li role="presentation"><a href="#min" aria-controls="min" role="tab" data-toggle="tab"><h3>MIN</h3></a></li>
        </ul>

        <!-- Tab panes -->
        <div class="tab-content br">
            <div role="tabpanel" class="tab-pane active" id="sd">
