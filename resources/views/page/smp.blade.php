...
<body>
    ...
    <div class="container bs-docs-container br">
        ...
        <ul class="nav nav-tabs br" role="tablist">
            <li role="presentation" class="active"><a href="#smp" aria-controls="smp" role="tab" data-toggle="tab"><h3>SMP</h3></a></li>
            <li role="presentation"><a href="#mts" aria-controls="mts" role="tab" data-toggle="tab"><h3>MTS</h3></a></li>
        </ul>

        <!-- Tab panes -->
        <div class="tab-content br">
            <div role="tabpanel" class="tab-pane active" id="smp">
            ...
            <div role="tabpanel" class="tab-pane" id="mts">
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="col-md-4">
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingTwo">
